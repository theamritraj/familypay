...
const ConsoleSidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const dropdownItems = [
    {
      ...
      items: [
        ...
        isPrimary && {
          ...
          icon: Users,
          path: "/dashboard/settings?tab=circle",
        },
        isPrimary && {
          title: "Payment Methods",
          icon: CreditCard,
          path: "/dashboard/settings?tab=payments",
        },
      ].filter(Boolean),
    },
  ];
          ...
          <div className="p-4 border-b border-border">
            <div className="flex items-center justify-between">
              ...
              >
                ...
                {isOpen && (
                  <div>
                    <h2 className="text-text font-semibold">FamilyPay</h2>
                    <p className="text-text-muted text-xs">Operations Console</p>
                  </div>
                )}
              </div>
              <button
              ...
              {isOpen && (
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-text-muted">
                    {isPrimary ? "Circle Owner" : "Circle Member"}
                  </p>
                </div>
              )}
            </div>
